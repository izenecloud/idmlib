...
struct ConceptClusteringInput
{
    ...
    void swap(ConceptClusteringInput& other)
    {
        concept_list.swap(other.concept_list);
        query.swap(other.query);
        query_term_list.swap(other.query_term_list);
        query_termid_list.swap(other.query_termid_list);
        doc_list.swap(other.doc_list);
    }
