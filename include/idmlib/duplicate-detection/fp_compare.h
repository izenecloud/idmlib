...
#ifndef IDMLIB_DD_FPCOMPARE_H_
#define IDMLIB_DD_FPCOMPARE_H_
...
{
public:
    FpCompare():num_(0), nStartCount_(0), invalid_(true)
    {
        //nouse
    }

    FpCompare(uint8_t num):num_(num), nStartCount_(0), invalid_(true)
    {
        init_(num_);
    }
